...
- Build responsive front-end interfaces using Angular, delivering user-facing features for property management and logistics workflows
- Leverage Claude AI and LLM tooling to accelerate software development, including AI-assisted code reviews, automated PR analysis pipelines, and intelligent code generation integrated into the CI/CD workflow
- Participate in requirements analysis and provide technical effort estimates for new features and enhancements
- Conduct code reviews and mentor team members on AWS best practices, serverless architecture patterns, and AI-assisted development workflows
...
### <span>Senior Web Developer, American University in Cairo</span> <span>November 2008 -- July 2018</span>
...
- Project Management Professional (PMP) - Preparation Course, American University in Cairo, 2023
...
## Skills
 ...
 - __AI-Assisted Development__: Claude AI API, LLM-powered code review, AI-integrated CI/CD pipelines, prompt engineering
 - __Development Practices__: Agile/Scrum, TDD, Unit Testing, Integration Testing, Load Testing, Code Review, Technical Leadership, Mentoring
